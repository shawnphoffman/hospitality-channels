	...
	return (
		<div>
			...
			<div className="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
				<StatCard title="Clips" value={String(clipsCount.value)} description="Total clip compositions" href="/clips" />
...
function StatCard({ title, value, description, href }: { title: string; value: string; description: string; href?: string }) {
	const content = (
		<>
	...
	return <div className="rounded-xl border border-slate-800 bg-slate-900 p-6">{content}</div>
}
