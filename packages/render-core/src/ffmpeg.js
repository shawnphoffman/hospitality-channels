...
export async function normalizeVideo(options) {
    const { inputPath, outputPath, trimSec = 3, durationSec = RENDER_DEFAULTS.durationSec, fps = RENDER_DEFAULTS.fps, width = RENDER_RESOLUTION.width, height = RENDER_RESOLUTION.height, } = options;
