...
import { providerBindingSchema } from '@hospitality-channels/content-model'
...
const updateClipSchema = z.object({
	...
	providersJson: z.array(providerBindingSchema).nullable().optional(),
...
export async function PUT(request: Request, props: { params: Promise<{ id: string }> }) {
	...
	await db
		...
		.set({
			...
			providersJson: body.providersJson !== undefined ? body.providersJson : existing.providersJson,
